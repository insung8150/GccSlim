...
- `bin/gccslim-slim`: stripped Rust slim binary.
- `bin/gccslim-claude-patch`: stripped Rust Claude patch binary.
...
Compatibility copies of `gccfork-slim` and `gccfork-claude-patch` are included because some internal dispatch paths still call those legacy binary names.
